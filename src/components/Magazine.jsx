    ...
    <div>
      ...
      <div className="mx-5 my-8  lg:flex lg:justify-center lg:gap-4 lg:w-[46rem] lg:mx-auto">
        ...
        <div className="">
          ...
          <p className="font-medium">
            ...
            bagaimana cara merawat outfit kamu. T-SHIRT PISAHKAN CUCIAN BERWARNA DAN PUTIH Sebelum dicuci, pisahkan terlebih dahulu t-shirt berwarna dan putih. Hal ini di lakukan untuk menghindari terjadi nya kelunturan warna serta menjaga
            agar kondisi dan kualitas warna t-shirt tetap terjaga.JANGAN MEMAKAI MESIN CUCI Ini merupakan cara yang cukup ampuh untuk menjaga kualitas t-shirt, walaupun menggunakan mesin cuci lebih mudah dan praktis, namun menggunakan mesin
            cuci dapat membuat kondisi t-shirt menjadi melar dan sablonan baju akan rusak. Cara...
          </p>
      ...
      <div className="mx-5 my-8 lg:flex lg:justify-center lg:gap-4 lg:w-[46rem] lg:mx-auto">
        ...
        <div>
          ...
          <p className="font-medium">
            SCREAMOUS CLOTHING Memasuki tahun ke-16 berkarya dan mengawali tahun ini dengan bangga kami mengumumkan akan kembali berkolaborasi dengan Usugrow, seniman Jepang asal Fukushima yang sangat kami kagumi karyanya. Ada banyak alasan
            mengapa kami memutuskan berkolaborasi untuk yang kedua kalinya dengan Usugrow. Selain karena kami sangat mengapresiasi karya-karyanya, juga karena ada keterhubungan yang kuat dengan konsistensi proses berkaryanya. Hal tersebut
            menginspirasi kami sebagai brand yang mengelaborasikan art dan music menjadi produk yang comfy dan timeless. USUGROWUsugrow merupakan seniman bereputasi dan berkelas dunia yang selalu diburu karyanya karena sejak memulai
            karirnya di tahun 1993, ia sudah memiliki ciri khas detail: goresan tinta hitam di atas kertas putih polos dengan desain tengkorak. Baginya tengkorak adalah simbol alam semesta. Ia juga dikenal piawai berkarya lewat ilustrasi,
            lukisan...
          </p>
          <p className="flex align-middle justify-start items-center my-5 hover:text-gray-700">
            <a href="#" className="italic font-bold text-orange-700 text-sm hover:text-gray-600">
              Continue reading -&gt;
            </a>
          </p>
        </div>
      ...
      <div className="mx-5 my-8 lg:flex lg:justify-center lg:gap-4 lg:w-[46rem] lg:mx-auto">
        ...
        <div>
          ...
          <p className="font-medium">
            Ada yang berbeda di Kickfest XIII yang hadir tanggal 31 Oktober-3 November 2019. Selain durasi perayaan yang lebih panjang menjadi 4 hari, Screamous akan hadir dengan tampilan yang fresh! Screamous mengajak youth generation
            untuk berani mengekspresikan diri melalui produk Screamous yang terelaborasi menjadi produk yang comfy, colorful, vibrant & high quality. Memberi dorongan untuk berani beda adalah cara kami untuk memperkuat identitas dalam
            keseharian dan bersikap. Itu yang coba kami usung dalam semua image identity Screamous. Di Kickfest kali ini kami sudah menyiapkan special merchandise; scarf eksklusif dan Screamous Festival Survival Kit untuk kamu semua yang
            berbelanja di booth Screamous dengan minimal pembelanjaan 250.000 rupiah. Tidak hanya itu, untuk para member, kami akan memberikan tambahan diskon 10% khusus yang berbelanja...
          </p>
          <p className="my-5 ">
            <a href="#" className="italic font-bold text-orange-700 text-sm hover:text-gray-700">
              Continue reading -&gt;
