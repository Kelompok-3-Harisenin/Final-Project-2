      ...
      <div className="header-wrapper bg-transparent pt-5">
        <div className="header-nav">
          <div className="container mx-auto flex justify-between items-center">
            <a href="" className="burger text-slate-900 relative w-[30px] h-[30px] bottom-[10px]">
              <div className="burger-icon absolute block h-[2px] top-[17px] bg-white w-5 left-1"></div>
              <div className="burger-icon absolute block h-[2px] top-[24px] bg-white w-5 left-1"></div>
              <div className="burger-icon absolute block h-[2px] top-[31px] bg-white w-5 left-1"></div>
            </a>

            <a href="" className="logo">
              <img className="max-h-14 max-w-[240px] sm:pl-12 pl-12" src="/assets/Homepage/hero-logo.png" alt="" />
            </a>
